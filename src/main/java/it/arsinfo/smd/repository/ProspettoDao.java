...
public interface ProspettoDao extends JpaRepository<Prospetto, Long> {
    ...
    List<Prospetto> findByOmaggio(TipoEstrattoConto anno);
    ...
    List<Prospetto> findByAnnoAndOmaggio(Anno anno, TipoEstrattoConto omaggio);

    List<Prospetto> findByPubblicazioneAndOmaggio(Pubblicazione pubblicazione,
            TipoEstrattoConto omaggio);

    List<Prospetto> findByMeseAndOmaggio(Mese anno, TipoEstrattoConto omaggio);
    ...
    List<Prospetto> findByAnnoAndPubblicazioneAndOmaggio(Anno anno,
            Pubblicazione pubblicazione, TipoEstrattoConto omaggio);
    ...
    List<Prospetto> findByAnnoAndMeseAndPubblicazioneAndOmaggio(Anno anno,
            Mese mese, Pubblicazione pubblicazione, TipoEstrattoConto omaggio);
