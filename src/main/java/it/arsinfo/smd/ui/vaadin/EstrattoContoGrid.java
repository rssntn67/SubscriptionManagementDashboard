...
public class EstrattoContoGrid extends SmdGrid<EstrattoConto> {
    ...
    public EstrattoContoGrid(String gridname) {
        ...
        setColumns("numero","pubblicazione.nome","importo","spesePostali",
                   "intestazione","sottoIntestazione","indirizzo","citta"
                   ,"cap","provincia","paese","abbonamento.intestatario.caption","destinatario.caption","tipoEstrattoConto","invio","abbonamento.anno");
