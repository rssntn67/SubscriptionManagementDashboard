...
public abstract class AbbonamentoAbstractGrid extends SmdGrid<Abbonamento> {

    private final FooterRow gridfooter;

    public abstract void setAbbonamentoGridColums();
    public AbbonamentoAbstractGrid(String gridName) {
        super(new Grid<>(Abbonamento.class),gridName);
        setAbbonamentoGridColums();
