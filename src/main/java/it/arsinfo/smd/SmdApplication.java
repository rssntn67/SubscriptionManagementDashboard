...
public class SmdApplication {
    ...
    public CommandLineRunner loadData(AnagraficaDao anagraficaDao, StoricoDao storicoDao,
        ...
        return (args) -> {
            ...
            log.info(Integer.toString(Smd.getNumeroPubblicazioni(Mese.MARZO, Mese.DICEMBRE, Mese.MARZO, TipoPubblicazione.ANNUALE)));
            log.info("Numero: Mese.APRILE, Mese.DICEMBRE, Mese.MARZO, TipoPubblicazione.ANNUALE)");
            log.info(Integer.toString(Smd.getNumeroPubblicazioni(Mese.APRILE, Mese.DICEMBRE, Mese.MARZO, TipoPubblicazione.ANNUALE)));
            log.info("Numero: Mese.MARZO, Mese.DICEMBRE, Mese.MARZO, TipoPubblicazione.SEMESTRALE)");
            log.info(Integer.toString(Smd.getNumeroPubblicazioni(Mese.MARZO, Mese.DICEMBRE, Mese.MARZO, TipoPubblicazione.SEMESTRALE)));
            log.info("Numero: Mese.SETTEMBRE, Mese.DICEMBRE, Mese.MARZO, TipoPubblicazione.SEMESTRALE)");
            log.info(Integer.toString(Smd.getNumeroPubblicazioni(Mese.SETTEMBRE, Mese.DICEMBRE, Mese.MARZO, TipoPubblicazione.SEMESTRALE)));
            log.info("Numero: Mese.OTTOBRE, Mese.DICEMBRE, Mese.MARZO, TipoPubblicazione.SEMESTRALE)");
            log.info(Integer.toString(Smd.getNumeroPubblicazioni(Mese.OTTOBRE, Mese.DICEMBRE, Mese.MARZO, TipoPubblicazione.SEMESTRALE)));
            log.info("");
